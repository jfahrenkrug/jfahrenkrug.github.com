...
So how do you create a Core Data application with MacRuby?<ol><li>Create a new MacRuby Application<img style="margin: 0px auto 10px; display: block; text-align: center; cursor: pointer;" src="http://1.bp.blogspot.com/_-dK4R3d1lbc/SPtZGEHLMqI/AAAAAAAAAjk/xZaeJRcrloM/s400/Picture+12.png" alt="" /></li><li>Paste the following code into that file:
